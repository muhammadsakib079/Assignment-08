...
const Services = () => {
    ...
    return (
        <div className="bg-white pt-22 pb-44 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className=" p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                        <div>
                            <img src="https://i.ibb.co.com/8LkzDC4W/success-doctor.png" alt="" />
                        </div>
                    ...
                    <div className=" p-6 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                        <div>
                            <img src="https://i.ibb.co.com/Kc6khRRF/success-review.png" alt="" />
                        </div>
                        <div className="text-4xl font-bold py-3">
                            {counts.reviews}+
                        </div>
