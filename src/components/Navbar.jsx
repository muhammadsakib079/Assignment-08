...
const Navbar = () => {
  ...
  const navLinkClass = ({ isActive }) =>
    `relative after:content-[""] after:absolute after:bottom-[-8px] after:left-0 after:w-full after:h-[3px] after:transition-transform after:duration-300 after:origin-left ${isActive ?
  ...
  return (
    <div className="navbar shadow-sm px-42 py-6 mulish">
      ...
      <div className="navbar-end">
        <NavLink to="/contact">
          <button className="btn btn-lg bg-[var(--button-background)] text-white px-8 py-6 font-medium rounded-full tracking-wider">
            Contact Now
          </button>
        </NavLink>
      </div>
